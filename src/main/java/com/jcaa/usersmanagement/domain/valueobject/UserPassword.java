...
public final class UserPassword {
  ...
  public static UserPassword fromPlainText(final String plainText) {
    ...
    // VIOLACIÓN Regla 10: magic number 12 ahora es una constante llamada BCRYPT_COST = 12
  ...
  private static void validateMinimumLength(final String normalizedValue) {
    // VIOLACIÓN Regla 10: magic number 8 ahora es una constante llamada MINIMUM_LENGTH = 8
